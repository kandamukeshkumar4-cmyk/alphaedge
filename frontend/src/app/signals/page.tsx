...
import { ArbOpportunityTable } from "@/components/ArbOpportunityTable";
  ...
  return (
    <main className="mx-auto max-w-[1200px] px-4 py-8 sm:px-5">
      ...
      {activeTab === "arbitrage" && (
        <div>
          <div className="mb-6">
            <h2 className="text-lg font-black text-text">PM↔Kalshi Arbitrage Signals</h2>
            <p className="mt-1 text-sm text-muted">
              Detected price discrepancies between Polymarket and Kalshi for the same
              underlying event. Each pair shows match confidence, combined price,
              theoretical edge, and a staleness countdown. Stale opportunities (TTL
              expired) are greyed out automatically.
            </p>
          </div>
          <ArbOpportunityTable />
        </div>

...
| AUD-09b | **Visual consistency (token/nav half)**: admin/calibration + chart hex → QuestFlow tokens (M-VIS-02); Discover+Home dedup, BottomNav Markets/Signals, portfolio history slug truncation (M-VIS-03) | TODO | split from AUD-09 |
